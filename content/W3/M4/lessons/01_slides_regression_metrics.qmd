...
2. Explain why regression models need dedicated evaluation metrics.
3. Interpret and compare MSE, ($R^2$), MAE, median AE, and MAPE.3
4. Diagnose regression models visually using prediction and residual plots.
5. Explain when a target transformation can improve model fit and metrics.
...
::: {.callout-note}
This is the default in sklearn when you call `.score()` for a regressor model.
:::
